<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Paket Baru</h2>
    </x-slot>
    ...
    <div class="py-12 max-w-xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white p-6 rounded-lg shadow">
            ...
            <form action="{{ route('superadmin.paket.store') }}" method="POST" class="space-y-4">
                @csrf
                <div>
                ...
                <div>
                    ...
                    <input type="number" name="tingkat" min="1" max="3" value="{{ old('tingkat') }}" required
                        class="mt-1 w-full rounded-md border-gray-300">
                </div>
                <div>
                ...
                <div>
                    ...
                    <textarea name="deskripsi" rows="3" class="mt-1 w-full rounded-md border-gray-300">{{ old('deskripsi') }}</textarea>
                </div>
